...
def create_login(root, visitor_log_window, registration_status):
	label = ctk.CTkLabel(master=root, text_color="gold", text="Welcome", font=("Helvetica", 30, "bold"))
	label.place(relx=0.5, rely=0.15, anchor="center")
	
	widget_frame = ctk.CTkFrame(master=root, fg_color="transparent")
	widget_frame.place(relx=0.1, rely=0.225)

	label_email = ctk.CTkLabel(master=widget_frame, text_color="gold", text="📧 Email", font=("Helvetica", 14, "bold"))
	...
	label_password = ctk.CTkLabel(master=widget_frame, text_color="gold", text="🔑 Password", font=("Helvetica", 14, "bold"))
	...
	divider = ctk.CTkLabel(master=widget_frame, text="or", font=("Helvetica", 14), text_color="gray")
	divider.pack(pady=1)
	...
	def register_user():
		...
		if not email or not password:
			...
			message_label.configure(text="La password deve avere almeno 6 caratteri.", text_color="red")
			message_label.place(relx=0.5, rely=0.825, anchor="center")
			return
